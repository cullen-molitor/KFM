...
ui <- dashboardPage(title = "KFM App",  skin = "blue",# UI   ----
  ...
  dashboardBody(
    ...
    setBackgroundColor(color = c("darkslategrey"), 
                       shinydashboard = TRUE),
    # ___ HTML Colors and sizes     ----
    tags$style(
      HTML(".tabbable > .nav > li > a {background-color: lightslategray;  color:white}",
           ".tabbable > .nav > li[class=active] > a {background-color: #3c8dbc; color:white}",
           ".main-header {position: fixed; width:100%;}",
           ".content {margin-top: 50px;}",
           ".irs-min, .irs-max {color: #f9f9f9; font-size: 12px; line-height: 1.333; background: #111;}",
           ".irs-grid-pol {background-color: black; color: white;}",
           ".irs-grid-text {font-size: 10pt; color: #f6f6f6;}",
